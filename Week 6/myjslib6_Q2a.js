...
let showButton = document.getElementById('button-Practical6_Q2a-showConcatenatedInfo');
showButton.addEventListener('click', function () {
    alert(showConcatenatedInfo());
});

let showGreeting = document.getElementById('button-Practical6_Q2a-showGreeting');
showGreeting.addEventListener('click', function () {
    if (inputName.value == "") {
        alert("You have not entered a name.")
    } else {
        alert("Hi " + inputName.value + ", welcome to Q2a!");
    }
})